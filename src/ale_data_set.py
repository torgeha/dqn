...
actions, and rewards.
    ...
    def random_batch(self, batch_size):
        ...
        while count < batch_size:
            ...
            # Both the before and after states contain phi_length frames, overlapping
            # except for the first and last.
            all_indices = np.arange(index, index + self.phi_length + 1)
            end_index = index + self.phi_length - 1
            
            # Check that the initial state corresponds entirely to a
            # single episode, meaning none but its last frame
            # (the second to last frame in imgs) may be
        ...
        # TODO: Explain in thesis how this differs from ATARI_ANN_DQN
...
def test_memory_usage_ok():
    ...
    for i in xrange(1000000000):
        ...
        if i > 200000:
            imgs, actions, rewards, next_states, terminals = \
